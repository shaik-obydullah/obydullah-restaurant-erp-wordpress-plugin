...
<div class="summary-grid">
    <div class="summary-card"><div class="label"><?php esc_html_e('Revenue', 'obydullah-restaurant-erp'); ?></div><div class="value"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($data['revenue'])); ?></div></div>
    <div class="summary-card"><div class="label"><?php esc_html_e('COGS', 'obydullah-restaurant-erp'); ?></div><div class="value"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($data['cogs'])); ?></div></div>
    <div class="summary-card"><div class="label"><?php esc_html_e('Gross Profit', 'obydullah-restaurant-erp'); ?></div><div class="value"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($data['gross_profit'])); ?></div></div>
...
<table>
    ...
    <?php foreach ($data['monthly'] as $m): ?>
        <tr>
            ...
            <td class="text-right"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($m->revenue)); ?></td>
            <td class="text-right"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($m->cogs)); ?></td>
            <td class="text-right"><?php echo esc_html(Obydullah_ERP_Helpers::format_currency($m->revenue - $m->cogs)); ?></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
